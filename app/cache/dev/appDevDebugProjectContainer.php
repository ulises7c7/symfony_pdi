...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'doncar_pdi', 'host' => '127.0.0.1', 'port' => '3306', 'user' => 'root', 'password' => 'manager', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/var/www/Symfony/src/DonCar/PDIBundle/Entity')), 'DonCar\\PDIBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('DonCarPDIBundle' => 'DonCar\\PDIBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/Symfony/src/DonCar/PDIBundle/Resources/views', 'DonCarPDI');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('e1c17eb6d66f101017340d5342cd27578e');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DonCarPDIBundle' => 'DonCar\\PDIBundle\\DonCarPDIBundle',
            ...
            'locale' => 'en',
            'secret' => 'e1c17eb6d66f101017340d5342cd27578e',
            'database_path' => NULL,
            ...
            'kernel.secret' => 'e1c17eb6d66f101017340d5342cd27578e',
